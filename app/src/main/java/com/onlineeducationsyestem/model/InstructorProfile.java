...
public class Datum {
    ...
    @SerializedName("list")
    @Expose
    private java.util.ArrayList<InstructorProfile.List> list = null;
    ...
    public java.util.ArrayList<InstructorProfile.List> getList() {
        return list;
    }

    public void setList(java.util.ArrayList<InstructorProfile.List> list) {
        this.list = list;
    }
